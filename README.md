...
- [x] Style the feed to look like the real Instagram feed. (kind of not fully)
...
Before logging in or signing up the user gets an option to view what the app is about
